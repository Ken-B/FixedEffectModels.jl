...
- Fixed effect variables are indicated with the keyword argument `fe`. They must be of type CategoricalArray (use `categorical` or `categorical!` to convert a variable to a `CategoricalArray`).
